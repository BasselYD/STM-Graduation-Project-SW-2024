...
//void func1 (void){printf("HAKUNA MATATA 1\n");}
//void func2 (void){printf("HAKUNA MATATA 2\n");}
//void func3 (void){printf("HAKUNA MATATA 3\n");}
//void func4 (void){printf("HAKUNA MATATA 4\n");}
//void func5 (void){printf("HAKUNA MATATA 5\n");}
//void func6 (void){printf("HAKUNA MATATA 6\n");}
